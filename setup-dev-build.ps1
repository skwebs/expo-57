...
elseif ($packageJson.devDependencies.PSObject.Properties.Name -contains "expo-dev-client") {
...
#     Write-ErrorMsg "android folder missing."
#     $success = $false
...
#     Write-ErrorMsg "ios folder missing."
#     $success = $false
...
# Write-Host ("iOS Native".PadRight(25) + ": " + ($(if($iosExists){"Yes"}else{"No"})))
